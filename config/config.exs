...
config :schoolmanagementsystem,
  ecto_repos: [Schoolmanagementsystem.Repo]
...
config :schoolmanagementsystem, Schoolmanagementsystem.Mailer, adapter: Swoosh.Adapters.Local
